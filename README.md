Polyphonic wavetable synthesizer built with JUCE (C++), available as VST3. Features 32 voices with additive harmonic synthesis all waveforms (Sine, Saw, Square, Triangle) are constructed from a single sine wavetable using Fourier series coefficients, enabling smooth fractional harmonic blending.
